...
define("drip/Activity", ["dojo/_base/declare",
	...
	var ActivityNode = declare("drip.ActivityNode",[_WidgetBase, _TemplatedMixin],{
		...
		postCreate : function(){
			...
			0 && console.log("exercise info:",exerciseInfo);
			...
			0 && console.log("activity node data:",this.data);
		...
		_createOption: function(parentNode,inputType, data, index){
			0 && console.log(parentNode, data, index);
