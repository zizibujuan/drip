define("drip/widget/form/uploader/FileList", [
	"dojo/_base/fx",
	"dojo/dom-style",
	"dojo/dom-class",
	"dojo/dom-prop",
...
return declare("drip.widget.form.uploader.FileList", [formUploaderBase], {
	...
	_progress: function(/*Object*/ customEvent){
		0 && console.log("onProgress",customEvent);
...
//		}
	...
	_onUploaderChange: function(fileArray){
		...
		0 && console.log("upload onUploadChange");
