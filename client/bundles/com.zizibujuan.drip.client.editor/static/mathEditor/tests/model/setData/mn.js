	...
	doh.register("Model.setData.mn number-输入数字",[
	    {
	    	...
	    	runTest: function(t){
	    		...
	    		var focusNode = model.getFocusNode();
  				t.is("mn", focusNode.nodeName);
  				t.is(1, model.getOffset());
  				t.is("21", dripLang.getText(focusNode));
	    	},
	    	tearDown: function(){
	    	...
	    	name: "在mn和mo之间插入数字，光标在mo的最前面",
  			...
  			runTest: function(t){
  				...
  				t.is("123", dripLang.getText(focusNode.previousSibling));
  			},
  			tearDown: function(){
	    	...
	    	name: "在mo和mn之间插入数字，光标在mo的最后面",
  			...
  			runTest: function(t){
  				...
  				t.is("mo", focusNode.nodeName);
  				t.is(1, model.getOffset());
  				t.is("123", dripLang.getText(focusNode.nextSibling));
  			},
  			tearDown: function(){
	    	...
	    	name: "在layout节点之后插入数字，layout被mstyle封装,layout是mfrac",
  			setUp: function(){
  				this.model = new Model({});
  			},
  			runTest: function(t){
	    	...
	    	name: "在layout节点之后插入数字，layout被mstyle封装,layout是msqrt",
  			setUp: function(){
  				this.model = new Model({});
  			},
  			runTest: function(t){
