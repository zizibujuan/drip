define([ "doh","mathEditor/Model" ], function(doh,Model) {
	...
	doh.register("Model.removeRight.root 右删除根式",[
	    {
	    	name: "右删除根数，根式中的根数为空时，右删除时，删掉整个根式，同时将根次中的内容放在之前的根式前,根式最后一个节点是token节点",
  			setUp: function(){
	    	...
	    	name: "右删除根数，根式中的根数为空时，右删除时，删掉整个根式，同时将根次中的内容放在之前的根式前,根式最后一个节点是layout节点",
  			setUp: function(){
  				this.model = new Model({});
  			},
  			runTest: function(t){
	    	...
	    	name: "右删除根数，根式中的根次为空时，右删除时，删掉整个根式，同时将根数中的内容放在之前的根式前,根数中最前一个节点是token节点",
  			setUp: function(){
  				this.model = new Model({});
  			},
  			runTest: function(t){
	    	...
	    	name: "右删除根数，根式中的根次为空时，右删除时，删掉整个根式，同时将根数中的内容放在之前的根式前,根数中最前一个节点是layout节点",
  			setUp: function(){
  				this.model = new Model({});
  			},
  			runTest: function(t){
